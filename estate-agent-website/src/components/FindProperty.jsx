...
//          maxTestBaths.innerHTML = "<option value='0'>No Max</option><option value='1'>1</option><option value='2'>2</option><option value='3'>3</option>
...
// "
 ...
 {/* Start the Price section */}
                        <div className="flex details">
                            <p>Price From:</p>
                            <select name="PriceMin" id="PriceMin" onChange={(e) => {setPriceMin(e.target.value)
...
{/* Start the Bedroom section */}

<div className="flex details">
                            <p>Bedroom Min:</p>
                            <select name="BedsMin" id="BedsMin" onChange={(e) => {setBedRoomsMin(e.target.value)
...
{/* End the Bedroom section */}

                        </div>
                        <div class="name-input left">
{/* Start the Bathroom section */}

<div className="flex details">
                            <p>Bathroom Min:</p>
                            <select name="BathsMin" id="BathsMin" onChange={(e) => {setBathRoomsMin(e.target.value)
